      ...
      >
        <div className="notification">
          ...
          {notifcationList.map((notification) => (
            <div key={notification.id} className="notification__card position-relative">
              <IconButton
                size="small"
              ...
              <Link to={`/${notification.path}`} onClick={handleDrawerToggle}>
                <Card className="mx-16 mb-24" elevation={38}>
                  ...
                  <div className="px-16 pt-8 pb-16">
                    ...
                    <small className="text-muted">{notification.subtitle}</small>
                  </div>
                </Card>
              </Link>
            </div>
...
export default withStyles(
  ...
  connect(mapStateToProps, { getNotification, deleteNotification, deleteAllNotification })(
    NotificationBar,
  ),
);
