...
import {
  Icon, Badge, MuiThemeProvider, IconButton, Drawer,
          ...
          {cartList.map((product) => (
            ...
            >
              <div className="flex flex-column mr-8">
                <IconButton
                  size="small"
                  onClick={() => updateCartAmount(user.userId, product.id, product.amount + 1)}
                >
...
export default withStyles(
  {},
  { withTheme: true },
)(connect(mapStateToProps, { getCartList, deleteProductFromCart, updateCartAmount })(ShoppingCart));
